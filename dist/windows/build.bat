...
cmake ../.. -G "MinGW Makefiles" -DCMAKE_CXX_FLAGS="-I%QT_INCLUDE_PATH% -I%MINGW_INCLUDE_PATH%" -DCMAKE_INSTALL_PREFIX=%MINGW_PATH% -DCMAKE_INSTALL_LIBDIR=%MINGW_BIN_PATH% -DTHREAD_LIBS=%THREAD_LIBS%
mingw32-make
